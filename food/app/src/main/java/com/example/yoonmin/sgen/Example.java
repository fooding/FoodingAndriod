...
public class Example extends Activity {
    ...
    private static final String APP_ID = "p93-yab-7q1bJFcyFVW6h-zYvv8Q_zhAvEUJvspl";
    private static final String APP_SECRET = "X_ZxZMs0ptFm1lazDLeIywwsTPWQeLY7SperKrgi";
